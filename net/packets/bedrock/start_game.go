...
func (pk *StartGamePacket) Encode() {
	...
	pk.PutBool(pk.EduFeaturesEnabled)
	...
	pk.PutBool(pk.PlatformBroadcast)
	pk.PutBool(pk.PlatformBroadcastMode)
	pk.PutBool(pk.XBOXBroadcastIntent)
	pk.PutBool(pk.LockedBehaviorPack)
	pk.PutBool(pk.LockedResourcePack)
	pk.PutBool(pk.FromLockedWorldTemplate)
	pk.PutBool(pk.UseMsaGamertagsOnly)
	pk.PutBool(pk.FromWorldTemplate)
	pk.PutBool(pk.WorldTemplateOptionLocked)
